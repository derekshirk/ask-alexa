...
class ACP_NetworkAdmin {
	...
	public function admin_menu() {
		$this->hook_suffix = add_submenu_page( $this->parent_slug, __( 'Admin Columns Settings', 'codepress-admin-columns' ), __( 'Admin Columns', 'codepress-admin-columns' ), 'manage_admin_columns', AC_Admin::MENU_SLUG, array( $this, 'display' ) );
	}
	...
	public function get_link() {
		return network_admin_url( add_query_arg( array( 'page' => AC_Admin::MENU_SLUG ), $this->parent_slug ) );
	}
